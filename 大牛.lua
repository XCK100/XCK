...
local Window = OrionLib:MakeWindow({Name = "大牛", HidePremium = false, SaveConfig = true,IntroText = "欢迎使用大牛脚本", ConfigFolder = "欢迎大牛脚本"})
...
about:AddParagraph("作者q : ","3592761157")
...
local Window = OrionLib:MakeWindow({IntroText = "“门” 脚本 大牛汉化",Name = "“门” 大牛汉化", HidePremium = false, SaveConfig = true, ConfigFolder = "DoorsSex"})
